...
public class NativeDialog extends Dialog {
    ...
    public NativeDialog(Context context, LatLng loc_now, LatLng loc_end) {
...
//    		for (AppInfo app : apps) {
    		for (int i = 0; i < apps.size(); i++) {
    			...
    			textView.setCompoundDrawablesWithIntrinsicBounds(null,app.icon, null, null);	//设置图标
    			textView.setText(app.appName);								//设置文字
    			...
    			textView.setTag(app.packageName);							//设置包名为tag
    ...
    private View.OnClickListener applistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(pak.equals("com.baidu.BaiduMap")){
